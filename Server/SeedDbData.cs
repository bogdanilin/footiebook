    ...
    public class SeedDbData
    {
        ...
        private void AddLanguagesAndContent()
        {
            ...
            if (!_context.Content.Any())
            {
                ...
                _context.SaveChanges();
                _context.Content.Add(new Content { Key = "APP_NAV_GROUPS" });
                _context.SaveChanges();
            }

            if (!_context.ContentText.Any())
            {
                _context.ContentText.Add(new ContentText { Text = "FootieBook", LanguageId = 1, ContentId = 1 });
                _context.ContentText.Add(new ContentText { Text = "FootieBook", LanguageId = 2, ContentId = 1 });
                ...
                _context.ContentText.Add(new ContentText { Text = "Identifier", LanguageId = 2, ContentId = 4 });

                _context.ContentText.Add(new ContentText { Text = "Logout", LanguageId = 1, ContentId = 5 });
                _context.ContentText.Add(new ContentText { Text = "Déconnecter", LanguageId = 2, ContentId = 5 });
                ...
                _context.ContentText.Add(new ContentText { Text = "Groups", LanguageId = 1, ContentId = 8 });
                _context.ContentText.Add(new ContentText { Text = "Groupes", LanguageId = 2, ContentId = 8 });
